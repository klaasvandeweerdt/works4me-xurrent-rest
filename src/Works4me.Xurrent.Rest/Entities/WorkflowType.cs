...
{
    /// <summary>
    /// Represents a Xurrent workflow type object.
    /// </summary>
    [DebuggerDisplay("{Id}")]
    public sealed class WorkflowType : RecordItem
    {
        /// <summary>
        /// Represents the queryable fields of a <see cref="WorkflowType"/> object.
        /// </summary>
        public enum Field
        {
            /// <summary>
        ...
        /// <summary>
        /// Represents the filterable fields of a <see cref="WorkflowType"/> object.
        /// </summary>
        public enum FilterField
        {
            /// <summary>
            /// Filters workflow types by creation date and time.
            /// </summary>
            [XurrentEnum("created_at")]
            CreatedAt,

            /// <summary>
            /// Filters workflow types by disabled state.
            /// </summary>
            [XurrentEnum("disabled")]
            Disabled,

            /// <summary>
            /// Filters workflow types by identifier.
            /// </summary>
            [XurrentEnum("id")]
            Id,

            /// <summary>
            /// Filters workflow types by name.
            /// </summary>
            [XurrentEnum("name")]
            Name,

            /// <summary>
            /// Filters workflow types by reference.
            /// </summary>
            [XurrentEnum("reference")]
            Reference,

            /// <summary>
            /// Filters workflow types by source identifier.
            /// </summary>
            [XurrentEnum("sourceID")]
            SourceID,

            /// <summary>
            /// Filters workflow types by last update date and time.
            /// </summary>
            [XurrentEnum("updated_at")]
            UpdatedAt
        }
        ...
        /// <summary>
        /// Represents the fields used to order a <see cref="WorkflowType"/> object.
        /// </summary>
        public enum OrderField
        {
            /// <summary>
            /// Sorts workflow types by creation date and time.
            /// </summary>
            [XurrentEnum("created_at")]
            CreatedAt,

            /// <summary>
            /// Sorts workflow types by identifier.
            /// </summary>
            [XurrentEnum("id")]
            Id,

            /// <summary>
            /// Sorts workflow types by name.
            /// </summary>
            [XurrentEnum("name")]
            Name,

            /// <summary>
            /// Sorts workflow types by position.
            /// </summary>
            [XurrentEnum("position")]
            Position,

            /// <summary>
            /// Sorts workflow types by reference.
            /// </summary>
            [XurrentEnum("reference")]
            Reference,

            /// <summary>
            /// Sorts workflow types by source identifier.
            /// </summary>
            [XurrentEnum("sourceID")]
            SourceID,

            /// <summary>
            /// Sorts workflow types by last update date and time.
            /// </summary>
            [XurrentEnum("updated_at")]
            UpdatedAt
        }
        ...
        /// <summary>
        /// Gets the aggregated attachments of the workflow type.
        /// </summary>
        ...
        /// <summary>
        /// Gets the date and time at which the workflow type was created.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the workflow type is disabled.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the information of the workflow type.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the position of the workflow type in a sorted list.
        /// </summary>
        ...
        /// <summary>
        /// Gets the reference of the workflow type.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the source of the workflow type.
        /// </summary>
        [XurrentField("source")]
        ...
        /// <summary>
        /// Gets or sets the source identifier of the workflow type.
        /// </summary>
        ...
        /// <summary>
        /// Gets the date and time at which the workflow type was last updated.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new workflow type instance.
        /// </summary>
        public WorkflowType()
        {
        }
        ...
        public WorkflowType(string name)
        {
